                                                    ...
                                                    i === 0 ? (
                                                        <div className="card-blog-1 card-blog-2 hover-up wow animate__animated animate__fadeIn" key={i}>
                                                            <div className="card-image mb-20">
                                                                <Link href={`/blog/${item.id}`}>
                                                                    <Image width={707} height={438} src={`/assets/imgs/page/healthy/${item.img}`} alt="Genz" />
                                                                </Link>
                                                            </div>
                                                                ...
                                                                <div className="row align-items-center mt-45">
                                                                    <div className="col-7">
                                                                        <div className="box-author">
                                                                            <Image width={48} height={48} src="/assets/imgs/page/homepage1/author.jpg" alt="Genz" />
                                                        ...
                                                        <div className="card-list-posts wow animate__animated animate__fadeIn" key={i}>
                                                            <div className="card-image hover-up">
                                                                <Link href={`/blog/${item.id}`} >
                                                                    <Image width={270} height={260} src={`/assets/imgs/page/healthy/${item.img}`} alt="Genz" />
                                                                </Link>
                                                            </div>
                                                            <div className="card-info">
                                                                ...
                                                                <div className="row mt-20">
                                                                    <div className="col-7">
                                                                        <Link className="color-gray-700 text-sm mr-15" href="/blog-archive"># Travel</Link>
