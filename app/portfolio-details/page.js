                                        ...
                                        <div className="content-detail border-gray-800">
                                            ...
                                            <div className="row mt-50 wow animate__animated animate__fadeIn">
                                                <div className="col-lg-6 gallery-left">
                                                    <Image width={320} height={410} className="img-bdrd-16 mb-30" src="/assets/imgs/page/portfolio/portfolio-2.png" alt="Genz" />
                                                </div>
                                                <div className="col-lg-6 gallery-right">
                                                    <Image width={365} height={192} className="img-bdrd-16 mb-20" src="/assets/imgs/page/portfolio/portfolio-3.png" alt="Genz" />
                                                    <Image width={365} height={192} className="img-bdrd-16" src="/assets/imgs/page/portfolio/portfolio-4.png" alt="Genz" />
                                                </div>
                                            </div>
