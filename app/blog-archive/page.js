                                                ...
                                                <div className="card-blog-1 hover-up wow animate__animated animate__fadeIn">
                                                    <div className="card-image mb-20">
                                                        ...
                                                        <Link href={`/blog/${item.id}`} >
                                                            <Image width={500} height={282} src={`/assets/imgs/page/travel-tip/${item.img}`} alt="Genz" />
                                                        </Link>
                                                    </div>
                                            ...
                                            <div className="col-lg-4" key={i}>
                                                <div className="card-blog-1 hover-up wow animate__animated animate__fadeIn">
                                                    <div className="card-image mb-20"><Link className="post-type" href="#" />
                                                        <Link href={`/blog/${item.id}`} >
                                                            <Image width={312} height={193} src={`/assets/imgs/page/travel-tip/${item.img}`} alt="Genz" />
                                                        </Link>
                                                    </div>
                                                    <div className="card-info">
                                                        <div className="row">
