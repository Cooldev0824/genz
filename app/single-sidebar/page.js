                            ...
                            <div className="col-xl-10 col-lg-12">
                                ...
                                <div className="row mt-30">
                                    <div className="col-lg-12">
                                        <div className="image-detail mb-30"><Image width={1110} height={450} className="bdrd16" src="/assets/imgs/page/single/img6.jpg" alt="Genz" /></div>
                                    </div>
                                    <div className="col-lg-8 m-auto">
                                        <div className="row mb-40">
                                            <div className="col-md-6 mb-10">
                                                <div className="box-author"><Image width={48} height={48} src="/assets/imgs/page/about/author2.png" alt="Genz" />
