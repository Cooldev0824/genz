        ...
        <>
            <div className="content-detail border-gray-800">
                ...
                <div className="mt-20 mb-20">
                    <Image width={730} height={330} className="img-bdrd-16" src="/assets/imgs/page/single/img.jpg" alt="Genz" />
                </div>
                ...
                <div className="row">
                    ...
                    <div className="col-lg-4">
                        <Image width={227} height={300} className="img-bdrd-16 mb-30" src="/assets/imgs/page/single/img2.jpg" alt="Genz" />
                    </div>
                </div>
                ...
                <div className="row mt-50">
                    <div className="col-lg-6 gallery-left">
                        <Image width={330} height={372} className="img-bdrd-16 mb-30" src="/assets/imgs/page/single/img3.jpg" alt="Genz" />
                    </div>
                    <div className="col-lg-6 gallery-right">
                        <Image width={376} height={176} className="img-bdrd-16 mb-20" src="/assets/imgs/page/single/img4.jpg" alt="Genz" />
                        <Image width={376} height={176} className="img-bdrd-16" src="/assets/imgs/page/single/img5.jpg" alt="Genz" />
                    </div>
                </div>
            ...
            <div className="box-comments border-gray-800">
                ...
                <div className="list-comments-single">
                    <div className="item-comment">
                        <div className="comment-left">
                            <div className="box-author mb-20">
                                <Image width={48} height={48} src="/assets/imgs/page/single/author.png" alt="Genz" />
                                <div className="author-info">
                                    <h6 className="color-gray-700">Robert Fox</h6>
                                    <span className="color-gray-700 text-sm mr-30">August 25, 2025</span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="item-comment">
                        <div className="comment-left">
                            <div className="box-author mb-20">
                                <Image width={48} height={48} src="/assets/imgs/page/single/author2.png" alt="Genz" />
                                <div className="author-info">
                    ...
                    <div className="item-comment item-comment-sub">
                        <div className="comment-left">
                            <div className="box-author mb-20">
                                <Image width={48} height={48} src="/assets/imgs/page/single/author3.png" alt="Genz" />
                                <div className="author-info">
