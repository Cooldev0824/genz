        ...
        <>
            <div className="row mt-70">
                <div className="col-lg-12">
                    ...
                    <p className="text-lg color-gray-500 wow animate__animated animate__fadeInUp">Do not miss the latest trends</p>
                                    ...
                                    <div className="card-list-posts card-list-posts-small wow animate__animated animate__fadeIn">
                                        <div className="card-image hover-up">
                                            <Link href={`/blog/${item.id}`}>
                                                <Image width={170} height={197} src={`/assets/imgs/page/homepage3/${item.img}`} alt="Genz" />
                                            </Link>
                                        </div>
